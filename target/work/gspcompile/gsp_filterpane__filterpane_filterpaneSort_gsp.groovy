...
public String getGroovyPageFileName() { "/WEB-INF/plugins/filterpane-2.3.2/grails-app/views/_filterpane/_filterpaneSort.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1422573688728L
